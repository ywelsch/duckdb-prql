...
wasm_mvp:
	...
	RUSTFLAGS="-Clink-arg=-sSIDE_MODULE=1" emmake make -j8 -Cbuild/wasm_mvp
...
wasm_eh:
	...
	RUSTFLAGS="-Clink-arg=-sSIDE_MODULE=1" emmake make -j8 -Cbuild/wasm_eh
...
wasm_threads:
	...
	RUSTFLAGS="-Clink-arg=-sSIDE_MODULE=1" emmake make -j8 -Cbuild/wasm_threads
